...
//            przed modyfikacja tk
//            if (this.bootcssVer == 3) {
//                this.picker.find(".prev span, .next span").toggleClass("glyphicon-arrow-left glyphicon-arrow-right")
//            }
            if (this.bootcssVer == 3) {
                this.picker.find(".prev p, .next p").toggleClass("glyphicon-arrow-left glyphicon-arrow-right")
            } else {
    ...
    }, headTemplate: '<thead><tr><th class="prev"><i class="icon-arrow-left"/></th><th colspan="5" class="switch"></th><th class="next"><i class="icon-arrow-right"/></th></tr></thead>', headTemplateV3: '<thead><tr><th class="prev"><p class="glyphicon glyphicon-arrow-left"></p> </th><th colspan="5" class="switch"></th><th class="next"><p class="glyphicon glyphicon-arrow-right"></p> </th></tr></thead>', contTemplate: '<tbody><tr><td colspan="7"></td></tr></tbody>', footTemplate: '<tfoot><tr><th colspan="7" class="today"></th></tr></tfoot>'};
